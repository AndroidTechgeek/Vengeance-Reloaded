	...
	.file	"bounds.c"
@ GNU C (Linaro GCC 4.7-2013.03) version 4.7.3 20130226 (prerelease) (arm-eabi)
@	compiled by GNU C version 4.5.2, GMP version 5.1.1, MPFR version 3.1.2, MPC version 1.0.1
@ GGC heuristics: --param ggc-min-expand=100 --param ggc-min-heapsize=131072
@ options passed:  -nostdinc
@ -I /home/rachit/android/tipo/kernel/arch/arm/include
@ -I arch/arm/include/generated -I include -I arch/arm/mach-msm/include
@ -iprefix /home/rachit/android/toolchains/linaro/bin/../lib/gcc/arm-eabi/4.7.3/
@ -D__USES_INITFINI__ -D __KERNEL__ -D __LINUX_ARM_ARCH__=7 -U arm
@ -D CC_HAVE_ASM_GOTO -D KBUILD_STR(s)=#s
@ -D KBUILD_BASENAME=KBUILD_STR(bounds)
@ -D KBUILD_MODNAME=KBUILD_STR(bounds)
@ -isystem /home/rachit/android/toolchains/linaro/bin/../lib/gcc/arm-eabi/4.7.3/include
...
@ -auxbase-strip kernel/bounds.s -Os -Wundef -Wstrict-prototypes
...
@ 0 "" 2
	...
	.fnend
	.size	foo, .-foo
	.ident	"GCC: (Linaro GCC 4.7-2013.03) 4.7.3 20130226 (prerelease)"
